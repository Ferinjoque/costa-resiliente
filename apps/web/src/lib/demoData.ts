...
export const DEMO_COPILOT_RESPONSES: Record<string, CopilotDemoResponse> = {
  ...
  "¿Cuál es el nivel del río Rímac en Chosica?": {
    ...
    sources: [
      { station: "Chosica", river: "Rímac", level_m: 2.4, flow_m3s: 185, alert_threshold_m: 2.5, status: "near_threshold" },
    ],
  },
  ...
  "¿Cuántas señales sociales urgentes hay ahora?": {
    ...
    sources: [
      { label: "huayco_observation", count: 4, top_district: "Lurigancho" },
      { label: "needs_help", count: 6, top_district: "Lurigancho" },
      { label: "flood_observation", count: 3, top_district: "La Molina" },
  ...
  "¿Qué estaciones hidrológicas están en alerta?": {
    ...
    sources: [
      { station: "Chosica", level_m: 2.4, threshold_m: 2.5, status: "near_threshold" },
  ...
  "Which hydrological stations are on alert?": {
    ...
    sources: [
      { station: "ANA-Chosica", river: "Rímac", level_m: 2.4, threshold_m: 2.5, status: "near_threshold" },
...
export const DEMO_SOCIAL_SIGNALS: SocialSignalCollection = {
  ...
  features: [
    ...
    { type: "Feature", geometry: { type: "Point", coordinates: [-76.91, -11.94] }, properties: { id: 7, source: "bluesky", triage_label: "flood_observation", triage_confidence: 0.81, ingested_at: hoursAgo(2.1), district_id: null, district_name: "San Juan de Lurigancho", text: "Lluvia intensa desde las 3am en SJL, no para. El Río Huaycoloro desbordó en zona baja. Calles inundadas." } },
    { type: "Feature", geometry: { type: "Point", coordinates: [-76.975, -11.980] }, properties: { id: 11, source: "telegram", triage_label: "huayco_observation", triage_confidence: 0.95, ingested_at: hoursAgo(0.6), district_id: 1, district_name: "Lurigancho", text: "AVISO: Flujo de lodo activo en Quebrada Huaycoloro. Baja piedras y barro. Evacúen zona baja inmediatamente. [PII eliminado]" } },
    { type: "Feature", geometry: { type: "Point", coordinates: [-76.970, -11.985] }, properties: { id: 12, source: "bluesky", triage_label: "huayco_observation", triage_confidence: 0.91, ingested_at: hoursAgo(0.9), district_id: 1, district_name: "Lurigancho", text: "Vimos huayco bajar por la quebrada detrás del sector 7. Mucho ruido, tierra y roca. Pidan ayuda urgente." } },
...
export const DEMO_DASHBOARDS: Record<string, DistrictDashboard> = {
  "150118": {
    ...
    social_24h: [
      { label: "huayco_observation",   count: 4 },
      { label: "needs_help",           count: 2 },
      { label: "road_blocked",         count: 3 },
      { label: "flood_observation",    count: 2 },
