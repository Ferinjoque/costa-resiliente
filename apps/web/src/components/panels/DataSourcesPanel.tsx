      ...
      {open && (
        ...
        >
          <p className="text-[10px] text-slate-300">
            <span className="text-slate-400">Cobertura:</span> {source.coverage}
          </p>
          <p className="text-[10px] text-slate-300">
            <span className="text-slate-400">Latencia:</span> {source.latency}
          </p>
          {source.notes && (
          ...
          <a
            ...
            aria-label={`Abrir ${source.name} en nueva pestaña`}
          >
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-700">
        ...
        <h2 className="text-sm font-semibold text-white">Sobre los datos</h2>
        <button
      ...
      <ul className="flex-1 overflow-y-auto" role="list" aria-label="Fuentes de datos">
        {SOURCES.map((s) => (
