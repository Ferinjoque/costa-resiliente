...
const GREETING_REPLY: Record<"es" | "en", string> = {
  es: "¡Hola! Soy el copiloto de Costa Resiliente. Prueba **'Dame el parte diario'** o **'Dame el resumen completo'** para un SITREP en ~6s con 6 fuentes de datos, o pregunta sobre alertas activas, niveles de ríos, lluvia acumulada, señales sociales, protocolos INDECI y más.\n\n¿Qué deseas consultar?",
  en: "Hi! I'm the Costa Resiliente copilot. Try **'Daily operational brief'** or **'Situation report please'** for a full SITREP in ~6s using 6 data sources, or ask about active alerts, river levels, accumulated rainfall, social signals, INDECI protocols, and more.\n\nWhat would you like to know?",
};
